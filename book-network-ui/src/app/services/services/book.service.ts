...
import { findAllReturnBooks } from '../fn/book/find-all-return-books';
import { FindAllReturnBooks$Params } from '../fn/book/find-all-return-books';
...
export class BookService extends BaseService {
  ...
  static readonly BorrowPath = '/books/borrow/{book-id}';
  ...
  /** Path part for operation `findAllReturnBooks()` */
  static readonly FindAllReturnBooksPath = '/books/returned';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `findAllReturnBooks()` instead.
   *
   * This method doesn't expect any request body.
   */
  findAllReturnBooks$Response(params?: FindAllReturnBooks$Params, context?: HttpContext): Observable<StrictHttpResponse<PageResponseBorrowedBookResponse>> {
    return findAllReturnBooks(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `findAllReturnBooks$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  findAllReturnBooks(params?: FindAllReturnBooks$Params, context?: HttpContext): Observable<PageResponseBorrowedBookResponse> {
    return this.findAllReturnBooks$Response(params, context).pipe(
